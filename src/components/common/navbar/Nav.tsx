...
export default function Navbar() {
  return (
    <div className="relative flex h-full w-28 max-w-[20rem] flex-col rounded-xl bg-white bg-clip-border p-4 m-6 text-gray-700 shadow-xl shadow-blue-gray-900/5">
      <div className="flex items-center w-20 h-20 gap-4 p-4 mb-2">
        <Link href="/">
